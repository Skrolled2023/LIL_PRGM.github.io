...
// const pdfFiles = ['./ASSETS/Home_compressed.pdf', './ASSETS/About_compressed.pdf', './ASSETS/Curriculum_compressed.pdf', './ASSETS/Contact Us.pdf'];
...
//     }
//     document.getElementById('pdfFrame').src = pdfFiles[currentPdfIndex];
// }
